...
using EliteKillerz.DotnetVcmp.RuntimeClient.VcmpSdk.PluginFunctionDelegates;
...
namespace EliteKillerz.DotnetVcmp.RuntimeClient.VcmpSdk
{
    ...
    public sealed class PluginFunctions
    {
        ...
        public GetPlayerInVehicleStateDelegate GetPlayerInVehicleState;
        ...
        public SetVehiclePartStateDelegate SetVehiclePartState;
        public GetVehiclePartStateDelegate GetVehiclePartState;
        public SetVehicleTireStateDelegate SetVehicleTireState;
        public GetVehicleTireStateDelegate GetVehicleTireState;
