...
namespace EliteKillerz.DotnetVcmp.RuntimeClient.VcmpSdk.PluginFunctionDelegates
{
    ...
    public delegate IntPtr GetPluginExportsDelegate(int pluginID, out IntPtr size);
    ...
    public delegate VcmpError GetPlayerIPDelegate(int playerID, [MarshalAs(UnmanagedType.LPStr)] string buffer, IntPtr size);
    public delegate VcmpError GetPlayerUidDelegate(int playerID, [MarshalAs(UnmanagedType.LPStr)] string buffer, IntPtr size);
    public delegate VcmpError GetPlayerUid2Delegate(int playerID, [MarshalAs(UnmanagedType.LPStr)] string buffer, IntPtr size);
    ...
    public delegate VcmpError GetPlayerNameDelegate(int playerID, [MarshalAs(UnmanagedType.LPStr)] string buffer, IntPtr size);
    ...
    public delegate PlayerInVehicleState GetPlayerInVehicleStateDelegate(int playerID);
    ...
    public delegate VcmpError SetVehiclePartStateDelegate(int vehicleID, int partID, int State);
    public delegate int GetVehiclePartStateDelegate(int vehicleID, int partID);
    public delegate VcmpError SetVehicleTireStateDelegate(int vehicleID, int tireID, int State);
    public delegate int GetVehicleTireStateDelegate(int vehicleID, int tireID);
