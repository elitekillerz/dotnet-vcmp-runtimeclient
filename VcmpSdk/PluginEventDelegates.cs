...
namespace EliteKillerz.DotnetVcmp.RuntimeClient.VcmpSdk.PluginEventDelegates
{
    ...
    public delegate void OnServerPerformanceReportDelegate(IntPtr entryCount, IntPtr description, ulong times);
